...
const NODE_LOCATIONS = {
  "ramallah-hospital-1": { lat: 31.9010, lng: 35.2005, label: "Ramallah General Hospital"  },
  "ramallah-ngo-1":      { lat: 31.9038, lng: 35.2034, label: "Ramallah NGO Center"         },
  "nablus-hospital-1":   { lat: 32.2215, lng: 35.2550, label: "Rafidia Surgical Hospital"   },
  "nablus-clinic-1":     { lat: 32.2190, lng: 35.2480, label: "Nablus Clinic"               },
  "hebron-hospital-1":   { lat: 31.5326, lng: 35.0998, label: "Al-Ahli Hospital Hebron"     },
  "jenin-hospital-1":    { lat: 32.4600, lng: 35.2960, label: "Jenin Governmental Hospital" },
  "jenin-field-1":       { lat: 32.4650, lng: 35.3010, label: "Jenin Field Unit"            },
  "tulkarm-ngo-1":       { lat: 32.3103, lng: 35.0281, label: "Tulkarm NGO Office"          },
};
